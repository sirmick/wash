...
func About() map[string]any {
	...
	return map[string]any{
		...
		"capabilities": map[string]bool{
			...
			"bulk_workspace_configuration": true, "qa_threads": true, "reviewer_capability_profiles": false,
		},
